\gfcommand{copyproof}{copy the current proof}
\index{copyproof}
...
\gfdescription{
   A new proof with name \ARG{prf-name} is created, and the current proof is
   copied in it.
}

\gfrecap{
A new proof with name `prf-name' is created, and the current proof 
is copied in it.
}
